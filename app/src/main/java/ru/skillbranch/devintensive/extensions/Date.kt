...
enum class TimeUnits(private val little: String, private var few: String, private var many: String)
{
    ...
    fun plural(value: Int) = when
    {
        value in 5..10 -> "$value $many"
        value.rem(10) == 1 -> "$value $little"
        value.rem(10) in 2..4 -> "$value $few"
        else -> "$value $many"
    }
}